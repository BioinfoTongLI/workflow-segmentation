...
NXF_OPTS='-Dleveldb.mmap=false' NXF_WORK=$TMP_NF_WORK LSB_DEFAULTGROUP='team283' /nfs/team283/software/nf/nextflow -trace nextflow.executor run /lustre/scratch117/cellgen/team283/tl10/workflow-segmentation/main.nf \
	-params-file $1 \
